...
const TitleBar: FC = () => {
    return (
        <div className="h-[calc(100vh_-_20px)] mt-5">
            <div data-tauri-drag-region className="fixed top-0 left-0 right-0 flex justify-end h-5 bg-gray-900 select-none">
                ...
                <div onClick={() => appWindow.hide()} className="inline-flex items-center justify-center w-6 h-5 cursor-pointer hover:bg-red-500" id="titlebar-close">
