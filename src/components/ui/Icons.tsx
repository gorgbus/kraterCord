...
export const AcceptIcon: FC<Props> = ({ size, color }) => {
    return <svg className={color} aria-hidden="false" width={size} height={size} viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M8.99991 16.17L4.82991 12L3.40991 13.41L8.99991 19L20.9999 7.00003L19.5899 5.59003L8.99991 16.17Z"></path></svg>
}
...
export const LoadingIcon: FC<Props> = ({ size, color }) => {
    const className = `animate-spin text-gray-600 ${color}`;

    return <svg role="status" className={className} width={size} height={size} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
