...
export const AddIcon: FC<Props> = ({ size, color }) => {
    return <svg className={color} x="0" y="0" aria-hidden="false" width={size} height={size} viewBox="0 0 18 18"><polygon fillRule="nonzero" fill="currentColor" points="15 10 10 10 10 15 8 15 8 10 3 10 3 8 8 8 8 3 10 3 10 8 15 8"></polygon></svg>
}

export const CloseIcon: FC<Props> = ({ size, color }) => {
    return <svg className={color} aria-hidden="false" width={size} height={size} viewBox="0 0 24 24"><path fill="currentColor" d="M18.4 4L12 10.4L5.6 4L4 5.6L10.4 12L4 18.4L5.6 20L12 13.6L18.4 20L20 18.4L13.6 12L20 5.6L18.4 4Z"></path></svg>
}
...
export const InviteIcon: FC<Props> = ({ size, color }) => {
    return <svg className={color} aria-hidden="true" role="img" width={size} height={size} viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M21 3H24V5H21V8H19V5H16V3H19V0H21V3ZM10 12C12.205 12 14 10.205 14 8C14 5.795 12.205 4 10 4C7.795 4 6 5.795 6 8C6 10.205 7.795 12 10 12ZM10 13C5.289 13 2 15.467 2 19V20H18V19C18 15.467 14.711 13 10 13Z"></path></svg>
}